        ...
        <div className="container max-w-6xl py-16 md:py-24">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="w-full max-w-3xl mt-16 rounded-lg overflow-hidden shadow-xl bg-gradient-to-b from-background to-background/80 border border-border/50">
              ...
              <div className="bg-[#151520] text-slate-100 p-4 font-mono text-sm overflow-auto max-h-[400px]">
                <div className="grid grid-cols-[auto,1fr] gap-x-4">
                  ...
                  <div>
                    ...
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-[#ff79c6]">return</span> <span className="text-[#f1fa8c]">`https://pastesharecopy.com/${"{"}generateId{"}"}`</span><span className="text-[#f8f8f2]">;</span></div>
